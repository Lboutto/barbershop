(function($){
	...
	$(document).ready(function() {
		...
		if (navbar.next().hasClass('bg-dark') || navbar.next().hasClass('bg-dark-30') || navbar.next().hasClass('bg-dark-60') || navbar.next().hasClass('bg-dark-30')) {
			...
			$(".selector-idiomas-item").addClass('white-item-selector');
			$("#selector-idiomas").addClass('white-item-selector');
		} else {
			navbar.removeClass('navbar-dark');
			$(".selector-idiomas-item").addClass('black-item-selector');
			$("#selector-idiomas").addClass('black-item-selector');
		}

		checkLanguageColor();

		function checkLanguageColor() {
			var width = Math.max($(window).width(), window.innerWidth);
			if (width < 767) {

				console.log("pantallapequeña");

				$(".selector-idiomas-item").removeClass('white-item-selector');
				$("#selector-idiomas").removeClass('white-item-selector');
				$(".selector-idiomas-item").addClass('black-item-selector');
				$("#selector-idiomas").addClass('black-item-selector');
				...
				if (navbar.next().hasClass('bg-dark') || navbar.next().hasClass('bg-dark-30') || navbar.next().hasClass('bg-dark-60') || navbar.next().hasClass('bg-dark-30')) {
					console.log("white");
					$(".selector-idiomas-item").removeClass('black-item-selector');
					$("#selector-idiomas").removeClass('black-item-selector');
		...
		$(window).on('resize', function() {
			...
			if (width > 767) {
				...
				$('.navbar-custom .navbar-nav > li.dropdown').hover(function() {
                                        if ($('.dropdown-menu', $(this)).offset() === undefined) {
                                            return false;
                                        }
